...
/*   Updated: 2021/09/01 18:53:23 by kmeeseek         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	_Hitpoints = 10;	//health points- максимальное количество урона, которое может получить объект. Если текущее количество очков здоровья достигает нуля, то объект погибает, либо теряет сознание
	_EnergyPt = 10;		
	_AttackDmg = 0;
	std::cout << _Name << " entered the game\n";
}
...
ClapTrap::~ClapTrap()
{
	std::cout << _Name << " exited the game\n";
}
